...
public interface BibliotekaInterfejs {
	 ...
	 *  ako uneta knjiga vec postoji u biblioteci (duplikat)
	 */
	 ...
	 * ako je uneta knjiga null
	 * @throws java.lang.IllegalArgumentException
	 *  ako uneta knjiga ne postoji u biblioteci
	 */
	 ...
	 * 
	 * @return Lista sva svim knjigama, ili 
	 * prazna lista ako u biblioteci nema knjiga (nije null)
	 */
	public List<Knjiga> vratiSveKnjige();
	
	/**
	 * Pretrazuje biblioteku i vraca knjige koje odgovaraju kriretijumima
	 * pretrage.
	 * 
	 * Mora da se unese bar jedan kriterijum pretrage.
	 * Pretraga se vrsi prema unetim kriterijumima, ali ne mora po svim.
	 * Ako se umesto kriterijuma unese null ili 0 (isbn), taj kriterijum
	 * se ne razmatra.
	 * 
	 ...
	 * 
	 * @return Lista sa knjigama koje odgovaraju kriterijumima ili prazna
	 * lista ako takvih knjiga nema.
	 * 
	 * @throws java.lang.IllegalArgumentException ako nije unet nijedan
	 * kriterijum za pretragu (svi su null ili 0 - isbn)
	 */
